...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, help="Path to the config.", default=r'config/potsdam/ab.py')
    # arg("-c", "--config_path", type=Path, help="Path to the config.", default=r'config/vaihingen/unetformer.py')
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename=f"{config.weights_name}" + "-{epoch:02d}-{val_F1:.4f}", 
        save_last=False 
    )
